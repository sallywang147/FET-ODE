...
def forecast_trend_plot(
    ...
    plt.legend()
    plt.savefig(f"Time_MMD_plots/Energy/multimodal/horizon12/{plot_name}", bbox_inches="tight")
    plt.show()
...
class TrainConfig:
    ...
    climate_csv: str = "Time_MMD/numerical/Energy/Energy.csv"
    report_csv: str = "Time_MMD/textual/Energy/Energy_report.csv"
    search_csv: str = "Time_MMD/textual/Energy/Energy_search.csv"
    target_col: str = "Weekly East Coast All Grades All Formulations Retail Gasoline Prices  (Dollars per Gallon)",
...
def merge_climate_with_text(
    climate_csv="Time_MMD/numerical/Energy/Energy.csv",
    report_csv="Time_MMD/textual/Energy/Energy_report.csv",
    search_csv="Time_MMD/textual/Energy/Energy_search.csv",
):
